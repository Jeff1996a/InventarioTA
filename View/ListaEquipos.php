        ...
        <table id="tblEquipos" class="table table-hover">
            ...
            while ($row = mysqli_fetch_assoc($GLOBALS['list'])) {
                ...
                <tr>
                    ...
                    <td>
                        <a id="btnHistorial" role="button" class="text-success" data-toggle="tooltip" data-placement="bottom" title="Historial">
                    ...
                    <td>
                        <a id="btnAccesorios" role="button" class="text-warning" data-toggle="tooltip" data-placement="bottom" title="Accesorios">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-pci-card" viewBox="0 0 16 16">
                    ...
                    <td>
                        <a id="btnEliminar" role="button" class="text-danger" data-toggle="tooltip" data-placement="bottom" title="Eliminar">
